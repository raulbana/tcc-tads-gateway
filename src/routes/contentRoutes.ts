...
contentRouter.post("/repost/:id", verifyJwt([Profile.ADMIN, Profile.PROFESSIONAL, Profile.USER]), ContentController.repostContent)
...
contentRouter.patch("/:id/save", verifyJwt([Profile.ADMIN, Profile.PROFESSIONAL, Profile.USER]), ContentController.toggleFavorite)
